...
export default function PassengerRegister() {
  ...
  const generatePassword = () => {
    ...
    console.log('generated pasword is :',password);
    return password;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedFormData = {
      ...
      password: autoGeneratedPassword // Set the auto-generated password
    };

    try {
      const response = await axios.post('http://localhost:3000/api/v1/passenger/register', updatedFormData); // Update with your backend route
